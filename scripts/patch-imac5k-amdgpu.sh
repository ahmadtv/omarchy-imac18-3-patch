...
# The stack: the lean core (the upstream candidate), then the stitch layer that
# presents both tiles as one output, then its one-display fix. Each must apply
# cleanly to pristine source, in this order, or nothing is installed.
